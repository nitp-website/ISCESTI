  ...
  return (
    <>
          ...
          <div className="header-title-section">
            <h1 className="conference-main-title">
              2nd International Conference on<br />
                Innovations and Sustainability in Civil Engineering <span className="conf-year">(ISCESTI-2027)</span>
            </h1>
            <p className="conference-date-text">May 27-29, 2027 · Department of Civil Engineering, NIT Patna</p>
          </div>
        ...
        <div className="container">
          ...
          <div className="intro-content">
            <div className="intro-text">
              <p>ISCESTI-2027 brings together researchers, practitioners and industry to discuss innovations and
                sustainability in civil engineering. The conference aims to foster knowledge exchange across geotechnical,
                structural, environmental, transportation and water resources engineering, and to highlight research that
                supports resilient, low-cost and sustainable infrastructure.</p>
              <p>The conference will include keynote lectures, technical sessions, poster presentations and a field trip for
                registered participants. Selected high-quality papers will be considered for publication in indexed
                proceedings or partner journals.</p>
            </div>
      ...
      <section className="scope">
        <div className="container">
          <h2>Themes</h2>
          <p>The conference covers conceptual and applied topics in civil engineering. Key themes include (but are not limited to):</p>
          
          <div className="scope-cards">
            <div className="card">
              <i className="fas fa-archway"></i>
              <h3>Geotechnical & Geo-environmental Engineering</h3>
              <p>Soil dynamics, rock mechanics, tunnelling, ground improvement and sustainable practices.</p>
            </div>
            <div className="card">
              <i className="fas fa-city"></i>
              <h3>Structural Engineering</h3>
              <p>Innovative materials, design for resilience, computational mechanics and numerical modelling.</p>
            </div>
            <div className="card">
              <i className="fas fa-leaf"></i>
              <h3>Water Resources & Hydraulic Engineering</h3>
              <p>River hydraulics, hydrological modelling, watershed management and climate adaptation.</p>
            </div>
            <div className="card">
              <i className="fas fa-hand-holding-heart"></i>
              <h3>Transportation & Pavement Engineering</h3>
              <p>Traffic modelling, pavement materials, low-cost alternatives and sustainable transport solutions.</p>
            </div>
          </div>
        </div>
      </section>
